...
public class VByteCompression {
	...
	public static int FindVByte(byte[] bytes, int offset){
		int size=0;
	...
	public static int VByteToInt(byte[] bytes,int begining, int size){
		int result=0;
		for(int j=size+begining-1, i=0; j>=begining;j--,i++){
